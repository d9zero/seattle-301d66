...
function displayPics(){
  ...
  // (PUT YOUR RESPONSE IN THIS COMMENT) The error in line 38 did not work properly in initializing the console log of "rando" because it is dependent upon the value or assignment of the variable "rando". Which is not defined. The mutable state of "rando" is changed when it is switched from 'var' to 'let'.
  console.log(viewed);
